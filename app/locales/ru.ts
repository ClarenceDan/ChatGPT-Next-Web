...
const ru: PartialLocaleType = {
  ...
  Error: {
    ...
    \\ 1️⃣ Нужны OpenAI, Claude, Gemini и другие? [Изучите MoleAPI 🚀](${SAAS_CHAT_UTM_URL})
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🎉 MoleAPI - Агрегатор AI API с поддержкой OpenAI, Claude, Gemini и других ведущих моделей!",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Использовать MoleAPI",
        Label: "(Платформа агрегации AI API)",
        SubTitle:
          "Поддерживает OpenAI, Anthropic Claude, Google Gemini, ChatGLM, Kimi, Minimax и другие ведущие AI-модели",
