...
const bn: PartialLocaleType = {
  ...
  Error: {
    ...
    \\ 1️⃣ OpenAI, Claude, Gemini এবং আরও প্রয়োজন? [MoleAPI অন্বেষণ করুন 🚀](${SAAS_CHAT_UTM_URL})
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🎉 MoleAPI - AI API অ্যাগ্রিগেটর, OpenAI, Claude, Gemini সহ আরও অনেক মডেল সমর্থন করে!",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "MoleAPI ব্যবহার করুন",
        Label: "(AI API অ্যাগ্রিগেটর প্ল্যাটফর্ম)",
        SubTitle:
          "OpenAI, Anthropic Claude, Google Gemini, ChatGLM, Kimi, Minimax সহ অনেক মূলধারার AI মডেল সমর্থন করে",
        ChatNow: "শুরু করুন",
      },
