...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ? `😆 对话遇到了一些问题，不用慌:
       \\ 1️⃣ 想接入 OpenAI、Claude、Gemini 等主流大模型？[点击了解 MoleAPI 🚀](${SAAS_CHAT_UTM_URL})
  ...
  Auth: {
    ...
    TopTips:
      "🎉 MoleAPI - AI 平台 API 聚合，支持 OpenAI、Claude、Gemini、ChatGLM 等主流大模型",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        ...
        Label: "（AI API 聚合平台）",
        SubTitle:
          "支持 OpenAI、Anthropic Claude、Google Gemini、智谱 ChatGLM、Kimi、Minimax、阿里通义千问等主流大模型",
        ChatNow: "立刻使用",
      },
      AccessCode: {
        Title: "访问密码",
