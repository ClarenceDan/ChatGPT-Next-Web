...
const ar: PartialLocaleType = {
  ...
  Error: {
    ...
    \\ 1️⃣ تريد الوصول إلى OpenAI و Claude و Gemini وأكثر؟ [اكتشف MoleAPI 🚀](${SAAS_CHAT_UTM_URL})
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🎉 MoleAPI - منصة تجميع واجهات برمجة الذكاء الاصطناعي، تدعم OpenAI و Claude و Gemini والمزيد",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "استخدام MoleAPI",
        Label: "(منصة تجميع واجهات برمجة الذكاء الاصطناعي)",
        SubTitle:
          "يدعم OpenAI و Anthropic Claude و Google Gemini و ChatGLM و Kimi و Minimax وأكثر من النماذج الكبيرة",
        ChatNow: "ابدأ الآن",
      },
      AccessCode: {
